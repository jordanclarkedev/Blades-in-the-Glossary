...
\` $finesse \` Finesse: You employ dextrous manipulation or subtle misdirection. 
\` $hunt \` Hunt: You carefully track a target. 
\` $prowl \` Prowl: You traverse skillfully and quietly. 
\` $skirmish \` Skirmish: You entangle a target in close combat so they can’t easily escape.
\` $study \` Study: You scrutinize details and interpret evidence.
\` $survey \` Survey: You observe the situation and anticipate outcomes.
\` $sway \` Sway: You influence someone with guile, charm, or argument.
\` $tinker \` Tinker: You fiddle with devices and mechanisms. 
\` $wreck \` Wreck: You unleash savage force.`

module.exports.attune = `**Attune**
...
module.exports.consort= `**Consort**
...
module.exports.finesse = `**Finesse**
...
module.exports.skirmish = `**Skirmish**
