...
Labor: A servant, a factory worker, a coach driver, a docker, a sailor, a Rail Jack, etc. A stevedore for the North Hook Company.
...
Noble: A dilettante, a courtier, the scion of a fallen house, etc. Underworld: A street urchin, gang member, young thug, or other outcast who grew up on the streets.
`;
...
module.exports.char5 = `5. Choose a special ability.
...
`;
module.exports.char6 = `6. Choose a close friend & a rival.
...
I'm made to help new players understand character and crew creation, as well as actions.
